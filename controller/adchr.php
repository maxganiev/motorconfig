...
class ControllerToolAdchrTestAdchr extends Controller
{
	...
	public function get_attrs()
	{
		...
		$json = $this->model_tool_adchr_test_adchr->get_attrs($this->request->post['keyword'], $this->request->post['type'], $this->request->post['model'], $this->request->post['pawtype'], $this->request->post['with_brakes'], $this->request->post['with_encoder'], $this->request->post['with_vent']);
